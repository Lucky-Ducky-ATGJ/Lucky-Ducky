...
$('#editTransaction').on('show.bs.modal', function (event) {
    ...
    var amount = button.parent().parent().children(":nth-child(2)").text() // Current bill amount
    var income = button.parent().parent().children(":nth-child(3)").text() // Current bill amount
    ...
    modal.find(".modal-body input#edit-amount").val(category);
